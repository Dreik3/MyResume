...
var HTMLgithub = '<li class="flex-item"><span class="orange-text">github</span><a id="githubLink" class="white-text" href="%link%">%data%</span></li>';
...
var HTMLprojectImage = '<img id="projectImage"  src="%data%">';
